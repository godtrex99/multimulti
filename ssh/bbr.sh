...
#BURIQ () {
 #   curl -sS https://raw.githubusercontent.com/arismaramar/permission/main/ipmini > /root/tmp
...
#Name=$(curl -sS https://raw.githubusercontent.com/arismaramar/permission/main/ipmini | grep $MYIP | awk '{print $2}')
