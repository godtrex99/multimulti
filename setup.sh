...
https://raw.githubusercontent.com/godtrex99/permission/main/ipmini 
...
PERMISSION () {
    ...
    res="Permission Denied! Please Contact Admin"
    fi
    BURIQ
}
...
if [ "" = "$PKG_OK" ]; then
  ...
  echo -e "[ ${tyblue}NOTES${NC} ] Notes, Script By : ANGGUN_VPN"
...
red " Permission Denied! Please Contact Admin t.me/arismaramar "
...
echo ""
wget -qc https://raw.githubusercontent.com/godtrex99/multimulti/main/dependencies.sh;chmod +x dependencies.sh;./dependencies.sh
rm dependencies.sh
clear
echo "----------------------------------------------------------------------------------"
...
#install ssh ovpn
sleep 1
echo -e "$yell[SERVICE]$NC Installing Script"
sleep 1
...
sleep 1
wget -qc https://raw.githubusercontent.com/godtrex99/multimulti/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Instal Xray
echo -e "$green[INFO]$NC Install Install XRAY!"
sleep 2
wget -qc https://raw.githubusercontent.com/godtrex99/multimulti/main/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
echo -e "$green[INFO]$NC SET BR"
sleep 2
wget -qc https://raw.githubusercontent.com/godtrex99/multimulti/main/backup/set-br.sh && chmod +x set-br.sh && ./set-br.sh
echo -e "$green[INFO]$NC Install SSH WS"
sleep 2
wget -qc https://raw.githubusercontent.com/godtrex99/multimulti/main/websocket/insshws.sh && chmod +x insshws.sh && ./insshws.sh
echo -e "$green[INFO]$NC Install SSH Non TLS"
sleep 2
wget -qc https://raw.githubusercontent.com/godtrex99/multimulti/main/websocket/nontls.sh && chmod +x nontls.sh && ./nontls.sh
echo -e "$green[INFO]$NC Install SSH Slow DNS"
sleep 2
wget -qc https://raw.githubusercontent.com/godtrex99/multimulti/main/slowdnss/install-sldns.sh && chmod +x install-sldns.sh && ./install-sldns.sh
echo -e "$green[INFO]$NC Install Update"
sleep 2
echo -e "$green[INFO]$NC Download Extra Menu"
wget -qc https://raw.githubusercontent.com/godtrex99/multimulti/main/update/update.sh && chmod +x update.sh && ./update.sh
clear
ln -fs /usr/share/zoneinfo/Asia/Jakarta /etc/localtime
clear
cat> /root/.profile << END
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/godtrex99/permission/main/version  )
...
echo ""  | tee -a log-install.txt
echo "   >>> Contact :  (Text Only)"  | tee -a log-install.txt
echo ""
echo ""
echo "------------------------------------------------------------"
echo ""
echo "===============-[ Script Recode By LoliNetz ]-==============="
echo -e ""
echo ""
echo "" | tee -a log-install.txt
