...
wget -qc -O /usr/bin/proxy3.js "https://raw.githubusercontent.com/godtrex99/multimulti/main/ssh/proxy3.js"
...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}" 
wget -qc -O /usr/bin/ssh-wsenabler "https://raw.githubusercontent.com/godtrex99/multimulti/main/ssh/sshws-true.sh" && chmod +x /usr/bin/ssh-wsenabler
