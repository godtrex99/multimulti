...
itoken=$(curl -sS https://raw.githubusercontent.com/arismaramar/permission/main/asi)

MYIP=$(curl -sS ipv4.icanhazip.com)
NameUser=$(curl -sS https://raw.githubusercontent.com/arismaramar/permission/main/ipmini | grep $MYIP | awk '{print $2}')
...
LLatest=`date`
Get_Data () {
git clone https://github.com/arismaramar/backupuserssn.git /root/user-backup/ &> /dev/null
}
...
Save_And_Exit () {
    ...
    git config --global user.name "anggun-vpn" &> /dev/null
    rm -rf .git &> /dev/null
    git init &> /dev/null
    git add . &> /dev/null
    git commit -m backup &> /dev/null
    git branch -M main &> /dev/null
    git remote add origin https://github.com/arismaramar/backupuserssn
    git push -f https://$itoken@github.com/arismaramar/backupuserssn.git &> /dev/null
}
...
link="https://raw.githubusercontent.com/arismaramar/backupuserssn/main/$NameUser/$NameUser.zip"
sleep 1
